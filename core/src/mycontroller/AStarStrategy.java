...
/**
 * Experimental class for testing extensibility with traversal search algorithms
 * @author : Sourced from Internet
 */
public class AStarStrategy implements TraversalStrategy {
    ...
    public AStarStrategy(CarState carState) {
